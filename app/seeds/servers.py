...
def seed_servers():
    ...
    server1 = Server(
        ...
        server_image = 'dithcord_server_image.png',
        owner_id = 1,
    )

    server2 = Server(
        name = 'Boxing',
        server_image = 'tysonBoxing_server_image.png',
        owner_id = 2,
    )

    server3 = Server(
        name = 'Tyson\'s Tigers',
        server_image = 'tysonTiger_server_image.png',
        owner_id = 3,
    )

    server4 = Server(
        name = 'Face Tattoos',
        server_image = 'tysonTattoo_server_image.jpg',
        owner_id = 4,
    )
